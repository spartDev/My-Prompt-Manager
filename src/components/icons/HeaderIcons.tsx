...
/**
 * Static icon elements hoisted to module scope for performance.
 * These are created once at module load time, avoiding JSX recreation on each render.
 * @see https://vercel.com/docs/workflow-collaboration/conformance/rules/NEXT_RENDERING_HOIST_JSX
 */

/** Logo Icon element - Chat bubble with dots */
const logoIconElement: JSX.Element = (
...
/** Add Icon element - Plus symbol */
const addIconElement: JSX.Element = (
  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
  </svg>
);

/** Edit Icon element - Pencil */
const editIconElement: JSX.Element = (
  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
  </svg>
);

/** Settings Icon element - Gear */
const settingsIconElement: JSX.Element = (
  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
/** Analytics Icon element - Bar chart */
const analyticsIconElement: JSX.Element = (
  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
 ...
 */
export const LogoIcon: FC = () => logoIconElement;

/**
 * Add Icon - Plus symbol
 * Used in AddPromptForm header
 */
export const AddIcon: FC = () => addIconElement;

/**
 * Edit Icon - Pencil
 * Used in EditPromptForm header
 */
export const EditIcon: FC = () => editIconElement;

/**
 * Settings Icon - Gear
 * Used in SettingsView header
 */
export const SettingsIcon: FC = () => settingsIconElement;

/**
 * Analytics Icon - Bar chart
 * Used in AnalyticsTab header and ViewHeader analytics button
 */
export const AnalyticsIcon: FC = () => analyticsIconElement;
