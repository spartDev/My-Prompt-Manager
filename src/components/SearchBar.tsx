  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full pl-12 pr-12 py-3 bg-white/60 dark:bg-gray-700/60 backdrop-blur-xs border border-purple-200 dark:border-gray-600 rounded-xl focus-input text-sm text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 shadow-sm hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-200"
